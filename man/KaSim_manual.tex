...
\lstinline[language=kappa]!%mod:$SPECIES_OF "species.ka" A(a!1), B(a!1) [true]!
prints in the file \ttt{"species.ka"} a new line for each new occurrence of \ttt{A(a!1), B(a!1)} and the time of occurrence.

Note that this perturbation can only be applied to if the observale is a connected component.
...
\begin{table}[htbp]
  \centering
  \caption{Agent signature with counters extends Table~\ref{tab:sig}}
  \begin{tabular}{@{} lcl @{}}
    \textit{signature\_expression} & ::= &
    \tcb{Id}\tcb{(}\textit{sig}\tcb{)} \\
...
\begin{center}
  \scalebox{0.8}{\includegraphics[bb=0 0 381 32]{gkappa_img/auto.pdf}}
\end{center}
...
\begin{figure}[t]
  ...
  \scalebox{0.7}{\includegraphics[bb=0 0 714 167]{gkappa_img/amb_noamb.pdf}}
...
\begin{figure}[t]
  \begin{minipage}{0.3\linewidth}
    \centering\scalebox{0.7}{\includegraphics[bb=0 0 183 31]{gkappa_img/symtt.pdf}}
  \end{minipage}\hspace*{5mm}
  \begin{minipage}{0.3\linewidth}
    \scalebox{0.7}{\includegraphics[bb=0 0 183 31]{gkappa_img/symff.pdf}}
  \end{minipage}\hspace*{5mm}
\begin{minipage}{0.3\linewidth}
    \centering\scalebox{0.7}{\includegraphics[bb=0 0 183 31]{gkappa_img/symtf.pdf}}
  \end{minipage}
...
\begin{minipage}{0.49\linewidth}
    \centering\scalebox{0.85}{\includegraphics[bb=0 0 183 31]{gkappa_img/symtt.pdf}}
  \end{minipage}


\begin{minipage}{0.49\linewidth}
  \centering\scalebox{0.85}{\includegraphics[bb=0 0 183 31]{gkappa_img/symff.pdf}}
\end{minipage}


\begin{minipage}{0.49\linewidth}
    \centering\scalebox{0.85}{\includegraphics[bb=0 0 183 31]{gkappa_img/symtf.pdf}}
  \end{minipage}
...
\centering  \begin{minipage}{0.35\linewidth}
   \scalebox{0.35}{\includegraphics[bb=0 0 480 360]{img/plot.png}}
\end{minipage}
...
\begin{figure}[htp]
\centering\begin{minipage}{0.35\linewidth}
  \scalebox{0.35}{\includegraphics[bb=0 0 480 360]{img/plot_fwd.png}}
\end{minipage}
...
\begin{figure}[htp]
\centering\begin{minipage}{0.35\linewidth}
  \scalebox{0.35}{\includegraphics[bb=0 0 480 360]{img/plot_bwd.png}}
